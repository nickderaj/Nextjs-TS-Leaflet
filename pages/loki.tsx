...
export default function Loki(_: PageWithLayout) {
...
Loki.getLayout = (page: React.ReactNode) => {
  return <PrimaryLayout title="Loki">{page}</PrimaryLayout>;
};
